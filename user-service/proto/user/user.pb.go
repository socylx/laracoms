...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x32, 0xcd, 0x03, 0x0a, 0x0b,
	...
	0x12, 0x49, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x52, 0x65, 0x73, 0x65, 0x74, 0x12, 0x13, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x50,
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x65, 0x74, 0x1a, 0x1b, 0x2e, 0x75,
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	5,  // 14: user.UserService.DeletePasswordReset:input_type -> user.PasswordReset
	2,  // 15: user.UserService.Create:output_type -> user.Response
	2,  // 16: user.UserService.Get:output_type -> user.Response
	2,  // 17: user.UserService.GetAll:output_type -> user.Response
	4,  // 18: user.UserService.Auth:output_type -> user.Token
	4,  // 19: user.UserService.ValidateToken:output_type -> user.Token
	2,  // 20: user.UserService.Update:output_type -> user.Response
	6,  // 21: user.UserService.CreatePasswordReset:output_type -> user.PasswordResetResponse
	4,  // 22: user.UserService.ValidatePasswordResetToken:output_type -> user.Token
	6,  // 23: user.UserService.DeletePasswordReset:output_type -> user.PasswordResetResponse
